    ...
    puts "Alguns valores podem ter sofido alterações, consulte a legislação vigente para mudanças no codigo fonte."
    puts "\n-------------------------------------------------"
    puts "\nDigite o valor salário base do funcionário em R$ (ex: 1500.00)"
    sb = gets.chomp.to_f
    # #sb = 1200
    # puts "\nDigite o valor salário base do funcionário em R$"
    #puts sb.to_s
    puts 'Digite número de horas extras 50% do funcionário (ex: 23.5)'
    he50 = gets.chomp.to_f
    # he50 = 5
    # puts "Digite número de horas extras 50% do funcionário"
    #puts he50.to_s
    puts 'Digite número de horas extras 100% do funcionário (ex: 23.5)'
